...
using Neurophotometrics.V2.PhotometryWriterHelpers;
...
namespace Neurophotometrics.V2
{
    ...
    public class PhotometryWriter
    {
        ...
        private ImageWriters CreateImageWriters(ref IObservable<PhotometryDataFrame> source, string parentDirectory, string suffixInstance)
        {
            ...
            {
                var type = Type.GetType("Neurophotometrics.V2.PhotometryWriterHelpers.ImageWriters, Neurophotometrics", true);
        ...
        private PlotsWriter CreatePlotsWriter(ref IObservable<PhotometryDataFrame> source)
        {
            if (IncludePlots)
            {
                var type = Type.GetType("Neurophotometrics.V2.PhotometryWriterHelpers.PlotsWriter, Neurophotometrics", true);

...
namespace Neurophotometrics.V2.PhotometryWriterHelpers
{
    public sealed class PlotsWriter
    {
        ...
        public IObservable<PhotometryDataFrame> Process(IObservable<PhotometryDataFrame> source)
        {
            return Observable.Defer(() =>
            {
                ...
                return source.Do(input =>
                {
                    ...
                    if (ledFlag == FrameFlags.None || ledFlag == (FrameFlags.L415 | FrameFlags.L470 | FrameFlags.L560))
                        return;
        ...
        private GraphPane CreateSignalPlot(SignalData signal)
        {
            ...
            signalPane.AddYAxis(signal.LedFlag.ToString());
        ...
        private Color GetColor(FrameFlags ledFlag)
        {
            switch (ledFlag)
            {
